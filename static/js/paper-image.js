...
window.onload = function () {
  ...
  currentState.circularFocus = null;
  var tempItems = [];
  ...
  tool.onMouseDown = function (event) {
    ...
    if(currentState.circularFocus) {
      currentState.circularFocus.remove();
    }
    // currentState.path = new Path({
    ...
    var rectangle = new Path.Rectangle(new Point(view.bounds.x, view.bounds.y), new Point(view.bounds.x+view.bounds.width, view.bounds.y+view.bounds.height));
    rectangle.fillColor=new Color(0, 0, 0, 0.5);
    rectangle.strokeColor=new Color(0, 0, 0, 0.5);


    currentState.circularFocus = new Path.Circle({
    ...
    //     250
    // );
    rectangle.subtract(currentState.circularFocus);
    currentState.circularFocus.remove();
    rectangle.remove();
    // circularFocus.fillColor = '#ff0000';
  }
